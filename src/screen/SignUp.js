        ...
        < >
            ...
            <SafeAreaView style={{ backgroundColor: '#fff', flex: 1 }}>
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    <View style={styles.inputView} >
                        <Icon name="mobile" size={25} color="rgba(0,150,90,1)" />
                        <TextInput value={mobile} onChangeText={text => setMobile(text)} style={styles.input} placeholder="Mobile No" placeholderTextColor="#818181" keyboardType="numeric" />
                    </View>
