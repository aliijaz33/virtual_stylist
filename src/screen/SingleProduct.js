            ...
            if (itemsVal) {
                let updateItems = array.map((curElem) => {
                    ...
                    if (curElem.id === products.id) {
                        ...
                        let qty = + curElem.quantity + 1;

                        let price = + curElem.productPrice + products.productPrice;
    ...
    return (
        <ScrollView>
            ...
            <View style={{ flex: 1, backgroundColor: '#EFF1F0' }}>
                ...
                <Text style={{ marginHorizontal: 20, alignSelf: 'center', color: 'black', fontSize: 25, marginVertical: 10 }}>
                ...
                <Text style={{ marginHorizontal: 20, color: 'black', fontSize: 25, marginVertical: 10 }}>Rs {products.productPrice}
                </Text>

                <Text style={{ marginHorizontal: 20, color: 'black', fontSize: 15, marginVertical: 10 }}>Tax Rs 0.00
                </Text>
